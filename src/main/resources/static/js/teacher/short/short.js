$(function () {
    ...
    $("#insert_submitExcel").click(function () {
        ...
        if(file != undefined){
            $.ajax({
                url: "/teacher/insertShortByExcel",
                data: formData,
                type: "post",
                processData: false,
                contentType: false,
